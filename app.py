...
def detail(keyword):
    api_key = 'b5f9dcc9-9393-4275-bd6f-1bd42b11134f'
    ...
    if type(definitions[0]) is str:
        return redirect(url_for(
            'error',
            msg=f'Your word "{keyword}", could not be found',
            suggest = 'Here are some suggested words',
...
def error():
    ...
    return render_template('search_error.html', msg = msg, definitions = definitions, suggest = suggest)
